...
<%@ page import="entity.Item,dao.ItemsDAO" %>
<%
  ...
  <head>
    ...
    <script type="text/javascript">
    	function selflog_show(id){
    		...
    		//id是窗口id号，title是窗口标题，link是窗口内容为外部链接页面，cover是是否打开遮罩层，默认为不打开
    	}
  	...
  	<center>
  		<table width="750" height="60" cellpadding="0" cellspacing="0" border="0">
  			...
  			<td width="70%" valign="top">
               ...
               <tr>
               	 <td>
               	 	购买数量:<span id="sub" onclick="sub()">-</span><input type="text" id="number" name="number" value="1" size="2"
  				...
  				<td width="30%" bgcolor="#EEE" align="center">
  					...
  					<!-- 循环开始 -->
  					<%
  						ArrayList<Item> itemList = itemsDao.getViewList(list);
					...
					<div>
						<dl>
							...
							<dd class="dd_city"><%=i.getCity() %>&nbsp;&nbsp;价格：<%=i.getPrice()%>￥</dd>		
						</dl>
					</div>  
					<%
							}
